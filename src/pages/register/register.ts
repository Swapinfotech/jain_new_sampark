...
export class RegisterPage {
  ...
  constructor(public navCtrl: NavController,public api: ApiService,public toastCtrl:ToastController,private transfer: FileTransfer,private camera: Camera,public imagePicker: ImagePicker, public actionSheetCtrl: ActionSheetController, private file: File,public loadingCtrl:LoadingController) {
  ...
  submitRegister(){ 
    ...
    // let contact_no = ;
      let userData = {"first_name" : this.first_name,"last_name" : this.last_name,"father_name":this.father_name,"mother_name":this.mother_name,"user_email" : this.user_email,"password": this.password,"contact_no" : [{"contact_number":this.contact_num,"contact_type":"PRIMARY"}], "profile_image":this.profile_image,"members":this.members};
