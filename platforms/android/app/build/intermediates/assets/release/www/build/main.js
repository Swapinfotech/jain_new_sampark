...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__searchlist_searchlist__ = __webpack_require__(235);
...
var SmsauthPage = /** @class */ (function () {
    function SmsauthPage(alertCtrl, navCtrl, formBuilder, events, nativeStorage, toastCtrl, loadingCtrl, menuCtrl, apiservice) {
        ...
        this.authForm = formBuilder.group({
            ...
            otp: ['', __WEBPACK_IMPORTED_MODULE_2__angular_forms__["f" /* Validators */].compose([__WEBPACK_IMPORTED_MODULE_2__angular_forms__["f" /* Validators */].required, __WEBPACK_IMPORTED_MODULE_2__angular_forms__["f" /* Validators */].minLength(4) /*,Validators.pattern("(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{4,}")*/])]
        });
    } // constructor close......
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_restapi_service__ = __webpack_require__(25);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__resetpass_resetpass__ = __webpack_require__(239);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var RegisterPage = /** @class */ (function () {
    function RegisterPage(navCtrl, api, toastCtrl, transfer, camera, imagePicker, actionSheetCtrl, file) {
        this.navCtrl = navCtrl;
        this.api = api;
        this.toastCtrl = toastCtrl;
    ...
    RegisterPage.prototype.submitRegister = function () {
        ...
        if (this.validateForm()) {
            ...
            var contact_no = [{ "contact_number": this.contact_num }];
            var userData = { "first_name": this.first_name, "last_name": this.last_name, "father_name": this.father_name, "mother_name": this.mother_name, "user_email": this.user_email, "password": this.password, "contact_no": contact_no, "profile_image": this.profile_image, "members": this.members };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__addphone_addphone__ = __webpack_require__(242);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__addmember_addmember__ = __webpack_require__(243);
...
var ApiService = /** @class */ (function () {
    function ApiService(http, loadingCtrl) {
        this.http = http;
        this.loadingCtrl = loadingCtrl;
        this.apiUrl = 'http://sampark.darshantraavels.com/wp-json/api/v1';
    ...
    ApiService.prototype.registerUser = function (data) {
        ...
        return new Promise(function (resolve, reject) {
            ...
            _this.http.post(_this.apiUrl + '/add_user', data1, { headers: headers })
    ...
    ApiService.prototype.loginUser = function (data) {
        ...
        return new Promise(function (resolve, reject) {
            ...
            headers.append('Api-Key', '39b1cdc8a1099ce2bb9f0000e860ad8c');
            var data1 = JSON.stringify(data);
            _this.http.post(_this.apiUrl + '/authenticate', data1, { headers: headers })
                .map(function (res) { return res.json(); })
                .subscribe(function (res) {
                _this.loading.dismiss();
                resolve(res);
    ...
    ApiService.prototype.dashboard = function () {
        ...
        return new Promise(function (resolve, reject) {
            ...
            headers.append('Content-Type', 'application/json; charset=utf-8');
            headers.append('Api-Key', '39b1cdc8a1099ce2bb9f0000e860ad8c');
            _this.http.get(_this.apiUrl + '/dashboard', { headers: headers })
                .map(function (res) { return res.json(); })
                .subscribe(function (res) {
                _this.loading.dismiss();
                resolve(res);
    ...
    ApiService.prototype.allSearch = function (data) {
        ...
        return new Promise(function (resolve, reject) {
            ...
            headers.append('Api-Key', '39b1cdc8a1099ce2bb9f0000e860ad8c');
            var data1 = JSON.stringify(data);
            _this.http.post(_this.apiUrl + '/search', data1, { headers: headers })
                .map(function (res) { return res.json(); })
                .subscribe(function (res) {
                _this.loading.dismiss();
                resolve(res);
    ...
    ApiService.prototype.feedback = function (data) {
        ...
        return new Promise(function (resolve, reject) {
            ...
            headers.append('Api-Key', '39b1cdc8a1099ce2bb9f0000e860ad8c');
            var data1 = JSON.stringify(data);
            _this.http.post(_this.apiUrl + '/user_feedback', data1, { headers: headers })
                .map(function (res) { return res.json(); })
                .subscribe(function (res) {
                _this.loading.dismiss();
                resolve(res);
    ...
    ApiService.prototype.update_user = function (data) {
        ...
        return new Promise(function (resolve, reject) {
            ...
            headers.append('Api-Key', '39b1cdc8a1099ce2bb9f0000e860ad8c');
            var data1 = JSON.stringify(data);
            _this.http.post(_this.apiUrl + '/update_user', data1, { headers: headers })
                .map(function (res) { return res.json(); })
                .subscribe(function (res) {
                _this.loading.dismiss();
                resolve(res);
    ...
    ApiService.prototype.state = function (data) {
        ...
        return new Promise(function (resolve, reject) {
            ...
            headers.append('Api-Key', '39b1cdc8a1099ce2bb9f0000e860ad8c');
            var data1 = JSON.stringify(data);
            _this.http.post(_this.apiUrl + '/stateslist', data1, { headers: headers })
                .map(function (res) { return res.json(); })
                .subscribe(function (res) {
                _this.loading.dismiss();
                resolve(res);
    ...
    ApiService.prototype.country = function (data) {
        ...
        return new Promise(function (resolve, reject) {
            ...
            headers.append('Api-Key', '39b1cdc8a1099ce2bb9f0000e860ad8c');
            var data1 = JSON.stringify(data);
            _this.http.post(_this.apiUrl + '/countrieslist', data1, { headers: headers })
                .map(function (res) { return res.json(); })
                .subscribe(function (res) {
                _this.loading.dismiss();
                resolve(res);
    ...
    ApiService.prototype.smsAuth = function (data) {
        ...
        return new Promise(function (resolve, reject) {
            ...
            headers.append('Api-Key', '39b1cdc8a1099ce2bb9f0000e860ad8c');
            var data1 = JSON.stringify(data);
            _this.http.post(_this.apiUrl + '/sms_authenticate', data1, { headers: headers })
                .map(function (res) { return res.json(); })
                .subscribe(function (res) {
                _this.loading.dismiss();
                resolve(res);
    ...
    ApiService.prototype.forgotPass = function (data) {
        ...
        return new Promise(function (resolve, reject) {
            ...
            headers.append('Api-Key', '39b1cdc8a1099ce2bb9f0000e860ad8c');
            var data1 = JSON.stringify(data);
            _this.http.post(_this.apiUrl + '/forgot_password', data1, { headers: headers })
                .map(function (res) { return res.json(); })
                .subscribe(function (res) {
                _this.loading.dismiss();
                resolve(res);
    ...
    ApiService.prototype.eventList = function () {
        ...
        return new Promise(function (resolve, reject) {
            ...
            _this.http.get(_this.apiUrl + '/event_list', { headers: headers })
                .map(function (res) { return res.json(); })
                .subscribe(function (res) {
                _this.loading.dismiss();
                resolve(res);
    ...
    ApiService = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__angular_http__["b" /* Http */], __WEBPACK_IMPORTED_MODULE_3_ionic_angular__["o" /* LoadingController */]])
    ], ApiService);
    return ApiService;
}());
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__pages_list_list__ = __webpack_require__(237);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__ionic_storage__ = __webpack_require__(43);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_ionic_img_viewer__ = __webpack_require__(325);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__pages_register_register__ = __webpack_require__(240);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__providers_restapi_service__ = __webpack_require__(25);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__pages_forgotpassword_forgotpassword__ = __webpack_require__(238);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__angular_http__ = __webpack_require__(234);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__pages_feedback_feedback__ = __webpack_require__(244);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__pages_search_search__ = __webpack_require__(125);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__pages_updateprofile_updateprofile__ = __webpack_require__(241);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_18__pages_logout_logout__ = __webpack_require__(245);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_19__pages_newsdetails_newsdetails__ = __webpack_require__(236);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_20__pages_details_details__ = __webpack_require__(126);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_21__pages_addphone_addphone__ = __webpack_require__(242);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_22__pages_addmember_addmember__ = __webpack_require__(243);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_27__pages_searchlist_searchlist__ = __webpack_require__(235);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_28__pages_smsauth_smsauth__ = __webpack_require__(131);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_29__pages_resetpass_resetpass__ = __webpack_require__(239);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var AppModule = /** @class */ (function () {
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["I" /* NgModule */])({
            ...
            imports: [
                __WEBPACK_IMPORTED_MODULE_0__angular_platform_browser__["a" /* BrowserModule */], __WEBPACK_IMPORTED_MODULE_14__angular_http__["c" /* HttpModule */], __WEBPACK_IMPORTED_MODULE_6__ionic_storage__["a" /* IonicStorageModule */].forRoot(), __WEBPACK_IMPORTED_MODULE_7_ionic_img_viewer__["a" /* IonicImageViewerModule */],
            ...
            providers: [
                ...
                __WEBPACK_IMPORTED_MODULE_9__ionic_native_splash_screen__["a" /* SplashScreen */], __WEBPACK_IMPORTED_MODULE_25__ionic_native_image_picker__["a" /* ImagePicker */],
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__pages_updateprofile_updateprofile__ = __webpack_require__(241);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__pages_feedback_feedback__ = __webpack_require__(244);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__pages_logout_logout__ = __webpack_require__(245);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var MyApp = /** @class */ (function () {
    ...
    MyApp = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["v" /* Platform */], __WEBPACK_IMPORTED_MODULE_2__ionic_native_status_bar__["a" /* StatusBar */], __WEBPACK_IMPORTED_MODULE_3__ionic_native_splash_screen__["a" /* SplashScreen */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* Events */]])
    ], MyApp);
    return MyApp;
}());
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__ionic_storage__ = __webpack_require__(43);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__pages_home_home__ = __webpack_require__(67);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__forgotpassword_forgotpassword__ = __webpack_require__(238);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__register_register__ = __webpack_require__(240);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__newsdetails_newsdetails__ = __webpack_require__(236);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__ionic_storage__ = __webpack_require__(43);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__providers_restapi_service__ = __webpack_require__(25);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
